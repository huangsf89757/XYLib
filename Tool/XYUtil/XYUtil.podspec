#
# Be sure to run `pod lib lint XYUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'XYUtil'
  s.version          = '1.0.0'
  s.summary          = 'A short description of XYUtil.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hsf89757/XYUtil'
  ...
  # 公共代码
  shared_files = 'XYUtil/Classes/**/*.swift'
