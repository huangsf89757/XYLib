//
//  XYPeripheralWrapperDelegate.swift
//  XYCoreBluetooth
//
...
public protocol XYPeripheralWrapperDelegate: CBPeripheralDelegate {
    // MARK: RSSI
    /// 读取RSSI通知
    /// - Parameters:
    ///   - peripheral: 外设实例
    ///   - _: 空参数
    func peripheralReadRSSI(_ peripheral: CBPeripheral)
...
public extension XYPeripheralWrapperDelegate {
    func peripheralReadRSSI(_ peripheral: CBPeripheral) {}
